...
def rollout_demo(env, agent, max_path_length=np.inf, animated=False, speedup=1, save_video=True, video_filename='sim_out.mp4'):
    """ Assumes policy needs 'objective_params' to sample an action, which is given by env.objective_params
    """
    observations = []
    actions = []
    rewards = []
